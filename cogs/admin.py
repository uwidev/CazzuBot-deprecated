...
class AdminCog():
    ...
    def __init__(self, bot):
        self.bot = bot
        self.selfroles_msg_id = 470366077071785994 # Hard-coded for now
        self.selfroles_roles_ch = 408848120240275456
    ...
    async def change_selfroles_msg(self, ctx, emoji:Emoji, to_add:bool):
        msg_obj = await self.bot.get_channel(self.selfroles_roles_ch).get_message(self.selfroles_msg_id)
